...
?></span>
				<?php 
_e( 'Specify suffix for your urls. For example ', 'premmerce-url-manager' );
?> <b>.html</b>
            </p>
        </th>
    </tr>
...
?>>
				<?php 
_e( 'Enable for products', 'premmerce-url-manager' );
?>
            </label>
            <p class="description">
                <span class="premium-only-feature"><?php 
...
if ( $product == 'slug' ) {
    ...
    ?><span
                                class="permalink_url_suffix"></span>
                    </code>
...
?>>
				<?php 
_e( 'Enable for categories', 'premmerce-url-manager' );
?>
            </label>
            <p class="description">
                <span class="premium-only-feature"><?php 
